...
```mermaid
graph TD
    A["7 Pilares Teóricos Atuais"] --> B["Triagem de Alternativas Recentes (2005–2025) & Mais Curtas"]
    B --> C["Critério 1: Rigor da Derivação Microeconômica"]
    B --> D["Critério 2: Aderência Exata ao PMM-E"]
    B --> E["Critério 3: Páginas de Foco (10–18 págs)"]
    
    C --> F["Decisão: MANTER ou SUBSTITUIR / COMPLEMENTAR"]
    D --> F
    E --> F
```
...
* **Análise Comparativa:**
  - *Roback (1982)* é o artigo seminal que provou matematicamente a equalização da utilidade indireta espacial $V(w_m, r_m; A_m) = \bar{u}$. É a citação obrigatória que dá peso acadêmico indiscutível ao uso do IVS 2010 como proxy de desamenidades $A_m$.
...
```mermaid
graph TD
    T1["M1: Roback 1982 / Sivey 2012 (14 págs)<br/>Oferta Espacial e WTA por IVS"]
    T2["M2: Agarwal 2015 AER (18 págs)<br/>Matching Centralizado no Edital Federal"]
    T3["M3: Acemoglu & Finkelstein 2008 JPE (20 págs)<br/>Complementaridade Fator-Tecnologia Hospitalar"]
    T4["M4: Baicker & Staiger 2005 QJE (12 págs)<br/>Substituição Fiscal e Crowding-Out Municipal"]
    T5["M5: Besley & Ghatak 2005 AER (14 págs)<br/>Agentes Motivados e Contratos em Saúde Pública"]
    T6["M6: Kline & Moretti 2014 ARE (17 págs)<br/>Avaliação de Bem-Estar em Políticas Place-Based"]
    T7["M7: Garicano 2000 JPE (14 págs)<br/>Hierarquia de Conhecimento e Resolutividade Local"]
    
    T1 --> ARTIGO["Seção de Arcabouço Teórico do Artigo PMM-E"]
    T2 --> ARTIGO
    T3 --> ARTIGO
    T4 --> ARTIGO
    T5 --> ARTIGO
