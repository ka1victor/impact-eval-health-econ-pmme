...
# Figuras : output/apresentacao_banca1/*.png (as oito usadas pelo deck)
...
# As oito figuras que o deck inclui (documento canônico, slides 4, 5 e 7).
for fig in \
  ...
  output/apresentacao_banca1/oferta_total_mensal.png
do
  if [[ ! -f "${fig}" ]]; then
