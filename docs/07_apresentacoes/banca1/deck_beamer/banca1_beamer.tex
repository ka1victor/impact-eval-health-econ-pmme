...
% ocupa na tela o mesmo que a Latin Modern a 11pt, e os frames compostos para
% ela continuam cabendo.
\documentclass[aspectratio=169,10pt]{beamer}

% Motor: o build oficial usa LuaLaTeX (fontspec carrega a Oswald da identidade
% e Latin Modern no corpo). Em pdflatex o deck tambem compila, com Latin
% Modern no corpo e TeX Gyre Heros Condensed como fonte de destaque.
\usepackage{iftex}
\ifPDFTeX
  ...
  \usepackage{lmodern}
\else
  \usepackage{fontspec}   % padrao: Latin Modern, mesma familia do pdflatex
\fi
...
% Fonte de destaque (Oswald, .ttf em fontes/), logo e foto da capa: caminhos
% relativos a raiz do repositorio (o build compila a partir dela). Ausentes,
% o tema cai em Heros Condensed e a capa usa os substitutos do pacote.
