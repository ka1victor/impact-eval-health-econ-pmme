...
% ===========================================================================
% 12 — De onde vem o modelo                                  (1 frame)
% ===========================================================================
...
\begin{frame}{De onde vem o modelo}
  ...
  \lead{estrutura da decisão}; as outras duas \lead{abrem o custo} --- uma o
  custo geográfico, a outra o custo de trabalhar.}

  \only<1>{%
    \vspace*{\stretch{1}}
    \begin{beamercolorbox}[wd=\textwidth,sep=1.1em,rounded=true]{block body}
      \normalsize
      \textbf{Moehling, Niemesh, Thomasson \& Treber (2020)}, eq. 1, p. 184
      \hfill {\color{cinzaFonte}\small estrutura da decisão}\\[0.5em]
  ...
  \only<2>{%
    ...
    \begin{beamercolorbox}[wd=\textwidth,sep=0.5em,rounded=true]{block body}
      \footnotesize
      \textbf{Redding \& Rossi-Hansberg (2017)}, eq. 24, p. 28
      \hfill {\color{cinzaFonte}custo geográfico}\\[0.2em]
    ...
    \begin{beamercolorbox}[wd=\textwidth,sep=0.5em,rounded=true]{block body}
      \footnotesize
      \textbf{Choné \& Ma (2011)}, eq. 1, p. 232
      \hfill {\color{cinzaFonte}custo de trabalhar}\\[0.2em]
      A utilidade do médico soma a renda, subtrai o custo de atender e soma o
      benefício ao paciente, ponderado pelo altruísmo. Equipe e capital
      instalado entram no custo de atender.
      \\[-0.7em]
      \[ U = R - C(q; L, K) + \alpha B(q) \]
    \end{beamercolorbox}

    \vspace{0.5em}
    {\footnotesize Nenhuma das três trata de um componente da remuneração
    fixado por \lead{regra pública sobre um índice territorial}. É isso que a
    adaptação ao PMM-E acrescenta.}
  }%
\end{frame}

% ===========================================================================
% 13 — Como o médico escolhe onde trabalhar                  (1 frame)
% A equacao e o glossario dos seus termos na mesma tela.
% ===========================================================================
...
\begin{frame}{Como o médico escolhe onde trabalhar}
  ...
  {\small A alternativa $m = 0$ é \textbf{ficar fora do programa}. A vaga em
  $m$ é aceita quando $V_{im} \geq V_{i0}$ e $m$ é a melhor opção entre as
  disponíveis.}

  \vspace{0.5em}
  {\footnotesize\renewcommand{\arraystretch}{1.08}
  \begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.20\textwidth} L@{}}
    \toprule
...
% ===========================================================================
% 14 — O que a bolsa paga — e o que não paga                 (1 frame)
% ===========================================================================
...
% ===========================================================================
% 15 — O custo de estar ali                                  (2 frames)
% ===========================================================================
...
\begin{frame}{O custo de estar ali}
  ...
  {\footnotesize O bloco \textbf{geográfico} vem de Redding \&
  Rossi-Hansberg; o \textbf{laboral}, de Choné \& Ma.}

  \vspace{0.4em}
  {\footnotesize\renewcommand{\arraystretch}{1.08}
  \begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.18\textwidth} >{\centering\arraybackslash}p{0.19\textwidth} L@{}}
    \toprule
  ...
  \vspace{0.6em}
  {\footnotesize Equipe ($L$) e capital instalado ($K$) atuam \lead{duas
  vezes} no bloco laboral: reduzem o cansaço, $\partial C/\partial K < 0$, e
  ampliam o benefício que o atendimento produz, $\partial B/\partial K > 0$.
  Por dois caminhos, $\partial c/\partial K < 0$. A segunda é \textbf{extensão
  deste projeto} a Choné \& Ma.}
\end{frame}
...
\begin{frame}{O custo de estar ali}
  ...
  \vspace{0.35em}
  \begin{destaque}
    \small Como no município vulnerável $L$ e $K$ são baixos, o mesmo lugar
...
% ===========================================================================
% 16 — O IVS organiza o custo                                (1 frame)
% ===========================================================================
...
% ===========================================================================
% 18 — Viabilidade empírica                                  (1 frame)
% ===========================================================================
