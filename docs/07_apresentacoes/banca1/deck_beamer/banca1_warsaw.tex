...
\begin{frame}[plain]
  ...
  \begin{center}
    \begin{minipage}{0.82\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.9em,center,rounded=true,%
        shadow=true]{title}
...
\begin{frame}{Pagar mais funciona: a evidência a favor}
  ...
  \vspace{0.9em}
  \centerline{\begin{minipage}{0.80\textwidth}%
  \begin{beamercolorbox}[wd=\textwidth,sep=0.8em,center,rounded=true,shadow=true]{block title}
    O degrau do programa --- R\$ 5 mil sobre R\$ 10 mil, ou
...
\begin{frame}{Duas hipóteses}
  \vspace{0.2em}
  {\small\lead{Passo 1 --- a condição de aceitação.} O médico $i$ aceita a vaga
  em $m$ quando o que ela vale supera sua melhor alternativa $\bar{v}_i$:}
  ...
  \vspace{0.9em}
  {\small\lead{Passo 3 --- as derivadas.}}
...
\begin{frame}{Duas hipóteses}
  ...
  que o \textbf{degrau monetário} supere o \textbf{degrau de custo}:

  \vspace{0.9em}
  \begin{center}
    \begin{minipage}{0.68\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=1.0em,center,rounded=true,%
        shadow=true]{block body}
