...
\begin{frame}{Especialistas não faltam; faltam no interior}
  ...
  país''}\\[0.2em]
  {\scriptsize\color{cinzaFonte}Senado Notícias, 25/09/2025, citando o Ministério da Saúde}

  \fonte{\textbf{Fontes:} Scheffer et al., \textit{Demografia Médica no Brasil
  2025} (FMUSP/AMB), dados de dezembro de 2024; recorte de imprensa citado.}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.7em,rounded=true]{block body}
        ...
        saúde pública pelos próximos dois anos''\\[0.3em]
        \upshape\scriptsize\color{cinzaFonte}Correio do Povo, 07/05/2025
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.7em,rounded=true]{block body}
        \small\itshape ``Aprovada no Senado, MP deve reduzir fila para
        atendimento por especialista no SUS''\\[0.3em]
        \upshape\scriptsize\color{cinzaFonte}Senado Notícias, 25/09/2025
      \end{beamercolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}{Onde a bolsa é maior, já havia menos especialistas}
  ...
  municípios} que receberam vaga no ciclo 1, um mês antes da oferta ser
  publicada:}
  ...
  \begin{columns}[T]
    \begin{column}{0.47\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.85em,rounded=true]{block body}
        \small\lead{Menos da metade.}\\[0.3em]
        Havia \num{16,0} especialistas por 100 mil habitantes nos municípios
        que pagariam R\$ 10 mil e \num{7,3} nos que pagariam R\$ 20 mil.
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.85em,rounded=true]{block body}
        \small\lead{E quem vai, vai sozinho.}\\[0.3em]
        Na Faixa 1, o especialista encontraria \num{2 colegas} da sua
        especialidade no município (mediana), contra \num{5} na Faixa 3; em
        \num{42\%} dos casos seria o único, ou teria um só colega.
      \end{beamercolorbox}
    \end{column}
  \end{columns}

  \fonte{\textbf{Fontes:} CNES, competência 06/2025; profissionais nos CBOs dos
  10 cursos do programa com correspondência unívoca curso--CBO; 295 municípios
  com vaga nesses cursos no ciclo 1; população residente do Censo 2022 (IBGE).
...
\begin{frame}{Onde a bolsa é maior, já havia menos especialistas}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Especialistas por 100 mil
  habitantes em junho de 2025, por faixa de bolsa. CNES, competência 06/2025;
  população residente do Censo 2022 (IBGE).\par}
\end{frame}
...
\begin{frame}{Onde a bolsa é maior, já havia menos especialistas}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Colegas da mesma especialidade no
  município em junho de 2025, por faixa de bolsa. CNES, competência
  06/2025.\par}
\end{frame}
...
\begin{frame}{O que o médico vê ao decidir}
  ...
  \begin{itemize}
    ...
    \item \textbf{Estados Unidos}, início do século XX: a escolha do lugar já
      ...
      \hfill{\scriptsize\color{cinzaFonte}Moehling et al., 2020}
    \item \textbf{Brasil}, 50 mil generalistas formados de 2001 a 2013:
      ...
      escala menor
      \hfill{\scriptsize\color{cinzaFonte}Costa, Nunes \& Sanches, 2024}
    \item \textbf{Austrália}, 3.727 clínicos perguntados sobre o que os faria
      ...
      para os demais, o valor exigido depende do tamanho da cidade e --- nas
      palavras dos autores --- \textit{``not only of the area but also of the
      characteristics of the job''}
      \hfill{\scriptsize\color{cinzaFonte}Scott et al., 2013}
  \end{itemize}}
...
\begin{frame}{O que é o PMM-E}
  ...
  \begin{beamercolorbox}[wd=0.86\textwidth,sep=0.7em,rounded=true]{block body}
    \small\centering O serviço \textbf{não pode substituir} profissional já
    contratado por um bolsista.
  \end{beamercolorbox}
...
\begin{frame}{O que é o PMM-E}
  \vspace{0.3em}
  \lead{Onde, no primeiro ciclo (julho de 2025)}
  ...
  \begin{columns}[T]
    \begin{column}{0.47\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.85em,rounded=true]{block body}
        ...
        estabelecimentos} e \num{368 municípios}, em \textbf{todas as UFs};
        678 para preenchimento imediato e 1.145 em cadastro de reserva.
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.85em,rounded=true]{block body}
        ...
        estado com mais vagas (252). Dois terços dos municípios têm menos de
        100 mil habitantes; \textbf{18 são capitais}.
      \end{beamercolorbox}
    \end{column}
  \end{columns}
...
\begin{frame}{O que é o PMM-E}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Células estabelecimento--curso e
  vagas imediatas do ciclo 1, por região. Quadro de vagas do ciclo 1,
  chamada 1.\par}
\end{frame}
...
\begin{frame}{A bolsa remunera o lugar}
  ...
  \begin{tabular}{@{}l c r@{}}
    \toprule
    \bfseries Categoria de IVS & \bfseries Faixa & \bfseries Bolsa mensal \\
    \midrule
...
\begin{frame}{A bolsa remunera o lugar}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Bolsa mensal por faixa de atração.
  Edital SGTES/MS nº 3/2025, item 11.1.3, e retificação.\par}
\end{frame}
...
\begin{frame}{Mas é caro, e não segura: a evidência contra}
  ...
  \begin{block}{Muitos não vão por preço nenhum}
    ...
    pedia \num{130\%} da renda anual.\\[0.3em]
    {\scriptsize\color{cinzaFonte}Scott et al. (2013), \textit{Social Science \& Medicine}}
  \end{block}
  ...
  \begin{block}{No Brasil, salário compra pouco e custa muito}
    ...
    \num{63,8\%}, por \num{US\$ 2,2 a 5,1 milhões} o ponto.\\[0.3em]
    {\scriptsize\color{cinzaFonte}Costa, Nunes \& Sanches (2024), \textit{Review of Economics and Statistics}}
  \end{block}
\end{frame}
...
\begin{frame}{Mas é caro, e não segura: a evidência contra}
  ...
  \begin{block}{E o médico vai embora quando a obrigação acaba}
    ...
    nenhuma}.\\[0.3em]
    {\scriptsize\color{cinzaFonte}Pathman, Konrad \& Ricketts (1992), \textit{JAMA}}
  \end{block}
...
\begin{frame}{No primeiro ciclo, a bolsa maior não ordenou o preenchimento}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Quadro de vagas e resultados do
  ciclo 1, chamada 1 (Ministério da Saúde, 2025); estratos pela REGIC 2018 e
  pela composição de regiões metropolitanas e RIDEs de 2022 (IBGE).\par}
\end{frame}
...
\begin{frame}{No primeiro ciclo, a bolsa maior não ordenou o preenchimento}
  ...
  \begin{itemize}
    \setlength{\itemsep}{0.8em}
    \item Por \textbf{faixa de bolsa}: 23,6\% na Faixa 3 (R\$ 10 mil), 37,4\%
      na Faixa 2 (R\$ 15 mil), \num{31,6\% na Faixa 1 (R\$ 20 mil)}.
      \\[0.2em]\lead{Pagar o dobro não preencheu mais que pagar uma vez e meia.}
    \item Por \textbf{território}: 44,9\% nos municípios metropolitanos, 35,6\%
      nas capitais, 26,9\% no interior conectado a um polo e \num{20,5\% no
      interior remoto}.
  \end{itemize}}
...
% ===========================================================================
% 13 — Como o médico escolhe onde trabalhar                (2 frames)
% ===========================================================================
...
\begin{frame}{Como o médico escolhe onde trabalhar}
  \vspace{0.6em}
  {\small
  \begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.24\textwidth} L@{}}
    \toprule
    \bfseries Termo & \bfseries Leitura \\
    \midrule
    $\mathbb{E}(w_{imt} \mid B_m)$ & remuneração esperada no município, dada a
      bolsa $B_m$ fixada pela regra \\
    ...
    $c_{im}$ & tudo o que torna estar naquele município custoso e não é pago
      em dinheiro \\
    $\delta^t$ & a decisão é de carreira, não de um mês: o médico pesa o que o
      lugar oferece ao longo do tempo \\
...
\begin{frame}{O custo de estar ali}
  ...
  \end{center}
  \vspace{0.1em}
  {\scriptsize\color{cinzaFonte}\centering Ilustração conceitual do modelo:
  custo laboral líquido em função do volume de atendimentos.\par}
\end{frame}
...
\begin{frame}{Duas hipóteses}
  ...
  \vspace{0.9em}
  {\small
  \begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.07\textwidth} L >{\centering\arraybackslash}p{0.34\textwidth}@{}}
    \toprule
...
\begin{frame}{Duas hipóteses}
  ...
  \vspace{0.5em}
  \centering
  \begin{beamercolorbox}[wd=0.72\textwidth,sep=1.0em,rounded=true,shadow=true]{block body}
    \centering
