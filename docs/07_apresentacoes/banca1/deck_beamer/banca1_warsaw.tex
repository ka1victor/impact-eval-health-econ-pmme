...
% ===========================================================================
% 4 — Onde a bolsa é maior, já havia menos especialistas     (1 frame)
...
\begin{frame}{Onde a bolsa é maior, já havia menos especialistas}
  ...
  \only<2>{%
    {\small \lead{E quem vai, vai sozinho.} Na Faixa 1 o especialista
    encontraria menos colegas da sua especialidade --- e é lá que é maior a
    chance de ser o único, ou de ter um só colega.}
  ...
  1; população do Censo 2022 (IBGE); faixa pela categoria de IVS do Ipea. A
  Faixa 1 tem 19 pares município--especialidade: a porcentagem oscila com
  poucos casos, a mediana não.}
\end{frame}
...
\begin{frame}{A bolsa remunera o lugar}
  ...
  \vspace{0.45em}
  {\small\lead{Dois cuidados.}}

  \vspace{0.25em}
  \begin{columns}[T]
    \begin{column}{0.49\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.6em,rounded=true]{block body}
        \footnotesize \textbf{A categoria que vale é a publicada na vaga.} Em
        \num{177 dos 368 municípios} ela não coincide com a que se obtém
        aplicando os cortes do Ipea ao IVS local.
      \end{beamercolorbox}
    \end{column}
    \begin{column}{0.49\textwidth}
      \begin{beamercolorbox}[wd=\textwidth,sep=0.6em,rounded=true]{block body}
        \footnotesize \textbf{A grade mudou em 2026.} A categoria
        \textit{alta} passou à \textbf{Faixa 1}.
      \end{beamercolorbox}
    \end{column}
  \end{columns}

  \fonte{\textbf{Fontes:} Edital SGTES/MS nº 3/2025, item 11.1.3, e
  retificação; Chamamento SGTES/MS nº 1/2026; quadro de vagas do ciclo 1.}
\end{frame}
...
\begin{frame}{Viabilidade empírica}
  ...
  \only<2>{%
    ...
    \begin{block}{A dificuldade}
      ...
      \vspace{0.4em}
      Isolar o efeito da bolsa do efeito do custo exige comparar municípios
      parecidos que caíram em faixas diferentes --- e a faixa publicada não
      coincide com a que sai dos cortes do Ipea em \textbf{177 dos 368
