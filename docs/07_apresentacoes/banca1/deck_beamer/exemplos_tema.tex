...
\begin{frame}{A moldura: título, corpo, fontes e rodapé}
  ...
  {\small A moldura não tem barra de navegação no topo. A trilha de seções
  mora no rodapé, onde não custa altura de corpo: são \num{0,60 cm} de
  ...
  \vspace{0.7em}
  {\small \lead{Registre a trilha no preâmbulo}, na ordem das seções, com os
  nomes curtos que o documento de conteúdo usa na linha de rastreio:}

  \vspace{0.4em}
  \cod{\textbackslash pmmeselecaoitem\{Motivação e Pergunta\}}\\
  \cod{\textbackslash pmmeselecaoitem\{Literatura e Modelo\}}\\
  \cod{\textbackslash pmmeselecaoitem\{Hipótese e Viabilidade\}}

  \vspace{0.7em}
  {\small Sem nenhum item registrado, o rodapé cai no \cod{\textbackslash
  rastreio\{...\}} manual, como antes.}

  \fonte{\textbf{Fontes:} este é o bloco \cod{\textbackslash fonte\{...\}},
  o único formato de fonte do deck.}
\end{frame}
