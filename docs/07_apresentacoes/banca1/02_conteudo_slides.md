...
O retrato nacional se repete dentro do programa. Nos **295 municípios** com
vaga no ciclo 1, um mês antes da oferta, **menos da metade** de especialistas
por habitante onde a bolsa seria maior — **e quem vai, vai sozinho**.

![Especialistas por 100 mil habitantes, jun/2025 — 16,0 na Faixa 3, 10,0 na Faixa 2, 7,3 na Faixa 1](../../../output/apresentacao_banca1/oferta_pre_por_faixa.png)

![Colegas da mesma especialidade no município, jun/2025 — mediana de 5, 3 e 2 da Faixa 3 à Faixa 1; em 15%, 34% e 42% dos casos o especialista seria o único ou teria um só colega](../../../output/apresentacao_banca1/retaguarda_por_faixa.png)

As duas figuras sustentam a mesma afirmação e dividem o slide; os números ficam
rotulados nelas e não se repetem em texto.
...
população do Censo 2022 (IBGE); faixa pela categoria de IVS do Ipea. A Faixa 1
tem 19 pares município–especialidade: a porcentagem oscila com poucos casos, a
mediana não.
...
**Dois cuidados.** A categoria que vale é a **publicada na vaga**: em **177 dos
368 municípios** ela não coincide com a que se obtém aplicando os cortes do
Ipea ao IVS local. E a grade mudou em 2026, quando a categoria *alta* passou à
**Faixa 1**.
...
Isolar o efeito da bolsa do efeito do custo exige comparar municípios parecidos
que caíram em faixas diferentes — e a faixa publicada não coincide com a que
sai dos cortes do Ipea em **177 dos 368 municípios** do ciclo 1.

**Recuperar a regra exata que o Ministério aplicou é o primeiro passo do
trabalho empírico.**
