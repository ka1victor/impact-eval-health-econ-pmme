...
Leia integralmente `AGENTS.md`, `CLAUDE.md`, `README.md`, `docs/02_inventario_dados_por_outcome.md`, `docs/04_escopo_eficacia_operacional.md` e `docs/05_roadmap_execucao.md`.
