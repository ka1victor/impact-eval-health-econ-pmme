...
> mas bloqueado por revisão independente; C3-02B é a próxima sessão. A
...
| 3 | [`02b_corrigir_e_validar_sih_pre.md`](02b_corrigir_e_validar_sih_pre.md) | **Executar agora** | SIH pré validado ou bloqueio documentado |
| 4 | [`03_torneio_pre_tratamento_e_pre_analise.md`](03_torneio_pre_tratamento_e_pre_analise.md) | Só após 02B | desenho e protocolo congelados |
...
- generalização: oncologia clínica e medicina intensiva; curso 2/CBO 225225 como
  sensibilidade;
- SIH local: piloto pré 2024-06--2026-06 presente, mas ainda não aprovado para
  o C3-03; SIA ausente;
