...
- **`tema_trabalho/`:** Resultados centrais da pesquisa atual:
  ...
  - `A8_conferencia_numeros_artigo.csv` (mapeamento de cada número do artigo para arquivo-fonte e localizador, gerado e validado por `10_conferir_numeros_artigo.py`).
