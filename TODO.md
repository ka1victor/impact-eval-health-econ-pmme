...
- [ ] Executar `prompts/01_auditoria_institucional.md`.
- [ ] Executar `prompts/02_auditoria_dados.md`.
- [ ] Incorporar e revisar os dois commits.
- [ ] Executar `prompts/03_protocolo_empirico.md`.
